...
class LinkedListSpec extends path.FunSpec with ShouldMatchers {
  describe("A Linked List") {
    ...
    // TODO change ignore to describe
    ignore("on creation") {
      describe("When Empty") {
        list = LinkedList()
    ...
    // TODO change ignore to describe
    ignore(":: - Adds an element at the beginning of this list.") {
      describe("When Empty") {
        list = LinkedList()
    ...
    // TODO change ignore to describe
    ignore("dropWhile - Drops longest prefix of elements that satisfy a predicate.") {
      describe("When Empty") {
        list = LinkedList()
    ...
    // TODO change ignore to describe
    ignore("++ - Returns a new list containing the elements from the left hand operand followed by the " +
    ...
    // TODO change ignore to describe
    ignore("foldLeft - Applies a binary operator to a start value and all elements of this sequence, going left to right.") {
      describe("When Empty") {
    ...
    // TODO change ignore to describe
    ignore("fold - Folds the elements of this traversable or iterator using the specified associative binary operator.") {
      describe("When Empty") {
    ...
    // TODO change ignore to describe
    ignore("reverse - Returns new list with elements in reversed order.") {
      describe("When Empty") {
        list = LinkedList()
    ...
    // TODO change ignore to describe
    ignore("foldRight - Applies a binary operator to all elements of this list and a start value, going right to left.") {
      describe("When Empty") {
    ...
    // TODO change ignore to describe
    ignore("reduce - Reduces the elements of this traversable or iterator using the specified " +
    ...
    // TODO change ignore to describe
    ignore("filter - Selects all elements of this traversable collection which satisfy a predicate.") {
      describe("When Empty") {
        list = LinkedList()
    ...
    // TODO change ignore to describe
    ignore("find - Finds the first element of the sequence satisfying a predicate, if any.") {
      describe("When Empty") {
    ...
    // TODO change ignore to describe
    ignore("map - Builds a new collection by applying a function to all elements of this list.") {
      describe("When Empty") {
        list = LinkedList[Int]()
    ...
    // TODO change ignore to describe
    ignore("flatten - Converts this list of traversable collections into a list formed by the elements of " +
    ...
    // TODO change ignore to describe
    ignore("flatMap - Builds a new collection by applying a function to all elements of this list and using " +
    ...
    // TODO change ignore to describe
    ignore("negate Negates the boolean operator of a predicate") {
      list = LinkedList(1)
    ...
    // TODO change ignore to describe
    ignore("partition - Partitions this traversable collection in two traversable collections " +
    ...
    // TODO change ignore to describe
    ignore("zip - Returns a list formed from this list and another iterable collection by combining " +
    ...
    // TODO change ignore to describe
    ignore("collect - Builds a new collection by applying a partial function to all elements of this " +
    ...
    // TODO change ignore to describe
    ignore("groupBy - Partitions this traversable collection into a map of traversable collections according " +
    ...
    // TODO change ignore to describe
    ignore("splitAt - Splits this list into two at a given position. " +
    ...
    // TODO change ignore to describe
    ignore("take - Selects first n elements.") {
      describe("When Empty") {
        list = LinkedList()
    ...
    // TODO change ignore to describe
    ignore("drop - Selects all elements except first n ones.") {
      describe("When Empty") {
        list = LinkedList()
    ...
    // TODO change ignore to describe
    ignore("last - Selects the last element.") {
      describe("When Empty") {
        list = LinkedList()
    ...
    // TODO change ignore to describe
    ignore("+: - A copy of the list with an element prepended.") {
      describe("When Empty") {
        list = LinkedList()
        it("should prepend one element")(list.+:(3) should equal(Node(3, Empty)))
        it("should be equivalent to List")(list.+:(3).toList should equal(List().::(3)))
    ...
    // TODO change ignore to describe
    ignore("::: - Adds the elements of a given list in front of this list.") {
      val listToBAdded = LinkedList(1, 2, 3)
      describe("When Empty") {
        list = LinkedList()
